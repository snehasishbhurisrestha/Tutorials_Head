<?php
    ...
    if(isset($_POST['save'])){
        ...
        $query = "INSERT INTO subject SET subject_name = '$subject_name'";
        $conn->query($query);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center">Add new <strong> Subject</strong></h1>
                    ...
                    <h1 class="h3 mb-4 mt-5 text-gray-800 text-center">Showing all<strong> Subject</strong></h1>
                    <div class="container">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="update_sub.php?id=<?php echo $row['subject_id']; ?>" class="btn btn-success">Edit</a></td>
                            <td><a onclick="confirm('Are you sure');" href="delete.php?id=<?php echo $row['subject_id']; ?>" class="btn btn-danger">Delete</a></td>
                        </tr>
                        <?php } ?>
                        </tbody>
                    </table>
